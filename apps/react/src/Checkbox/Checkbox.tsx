...
export const checkboxVariants = tv({
  ...
  slots: {
    ...
    control: [
      ...
      'data-checked:trds-bg-primary data-checked:trds-text-primary-fg data-checked:trds-border-primary-boundary',
      'data-invalid:trds-border-danger',
      'data-indeterminate:trds-bg-primary data-indeterminate:trds-text-primary-fg data-indeterminate:trds-border-primary-boundary',
