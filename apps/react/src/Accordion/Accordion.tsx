...
export const accordionVariants = tv({
  ...
  slots: {
    root: 'trds-w-full',
    item: 'trds-border-b trds-border-grayscale-300',
    itemTrigger:
      'trds-transition-all trds-duration-normal trds-w-full trds-py-4 trds-flex trds-flex-row trds-justify-between trds-items-center trds-cursor-pointer disabled:trds-text-muted-fg disabled:trds-cursor-not-allowed',
    itemIndicator:
