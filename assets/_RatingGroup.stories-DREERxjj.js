import{j as e}from"./jsx-runtime-qGIIFXMu.js";import{R as s}from"./RatingGroup-DjedJYzh.js";import"./index-CDs2tPxN.js";import"./index-9MS2e6do.js";import"./tv-Br1lVx4G.js";import"./factory-BCO0_PXk.js";import"./index-B-yFm4aN.js";import"./create-split-props-u5h9OPvL.js";import"./index-DRtd-hRg.js";import"./index-DBzJ7FiP.js";import"./index-B1LdDssV.js";import"./use-locale-context-CTaGYWMe.js";import"./use-event-eGuf5zsd.js";import"./use-field-context-CzRTzM_q.js";const C={title:"Components/RatingGroup",component:s,parameters:{layout:"centered",docs:{description:{component:"based on https://ark-ui.com/react/docs/components/select"}}},tags:["autodocs"],argTypes:{count:{control:{type:"number"}},defaultValue:{control:{type:"number"}},disabled:{control:{type:"boolean"}},readOnly:{control:{type:"boolean"}}},args:{count:5,defaultValue:3,disabled:!1,readOnly:!1}},o={args:{},render:r=>e.jsx(s,{...r})},a={args:{},render:r=>e.jsx(s,{...r,allowHalf:!0})},t={args:{},render:r=>e.jsxs("div",{className:"trds-flex trds-flex-col trds-gap-4",children:[e.jsx(s,{...r,size:"sm"}),e.jsx(s,{...r,size:"md"}),e.jsx(s,{...r,size:"lg"})]})},n={args:{},render:r=>e.jsx(s,{...r,disabled:!0})},p={args:{defaultValue:2.5},render:r=>e.jsx(s,{...r,allowHalf:!0,readOnly:!0})};var l,d,i;o.parameters={...o.parameters,docs:{...(l=o.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {},
  render: (props: RatingGroupProps) => {
    return <RatingGroup {...props} />;
  }
}`,...(i=(d=o.parameters)==null?void 0:d.docs)==null?void 0:i.source}}};var u,c,m;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {},
  render: (props: RatingGroupProps) => {
...
}`,...(z=(j=p.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};const T=["Default","AllowHalf","Size","Disabled","ReadOnly"];export{a as AllowHalf,o as Default,n as Disabled,p as ReadOnly,t as Size,T as __namedExportsOrder,C as default};
