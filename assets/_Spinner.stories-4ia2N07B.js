import{j as s}from"./jsx-runtime-qGIIFXMu.js";import{r as k}from"./index-CDs2tPxN.js";import{a as l}from"./cva-C095pwBQ.js";import{S as e}from"./Spinner-BE0ZfWCW.js";const i=["xs","sm","md","lg","xl"],v={title:"Components/Spinner",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{size:{options:i,control:{type:"select"}}},args:{size:i[2]}},n={args:{label:"loading..."},render:r=>s.jsx(e,{...r})},o={args:{label:"loading..."},render:r=>s.jsx("div",{className:l({display:"flex",flexDir:"row",gap:4}),children:i.map(c=>k.createElement(e,{...r,size:c,key:c}))})},a={args:{label:"loading..."},render:r=>s.jsx(e,{...r,className:l({borderBottomColor:"blue",borderLeftColor:"blue"})})},t={args:{label:"loading..."},render:r=>s.jsx(e,{...r,className:l({borderColor:"neutral.300"})})},p={args:{label:"loading..."},render:r=>s.jsx(e,{...r,className:l({borderWidth:4})})};var d,m,u;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    label: 'loading...'
  },
