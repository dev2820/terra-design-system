...
export const colors = {
  ...
  neutral: {
    ...
    subtler: `var(--my-colors-neutral-subtler, ${TOKEN.colors.gray[300]})`, //used
    subtlest: `var(--my-colors-neutral-subtlest, ${TOKEN.colors.gray[200]})`, //used
  ...
  layer: {
    ...
    highlight: `var(--my-colors-layer-highlight, ${TOKEN.colors.gray[200]})`,
